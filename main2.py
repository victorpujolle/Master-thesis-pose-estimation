...
if __name__ == '__main__':
    ...
    for i in range(nb_img):
        ...
        s_fp, Z_fp, R_fp, T_fp = full_model_opt(W_homo, D, model, verb=0)
        # --------------------------------------------------------------------------------------------
        ...
        print('R : \n', R_fp)
        print('T : \n', T_fp)
        print('R angle :', anglerotation(R_fp))
        ...
        ax2.plot(bb[:, 0], bb[:, 1], 'rx')

        polygon1 = Polygon(shape_wp_gt[0:2,:].T, linewidth=2, edgecolor='b', facecolor='none')
        ax2.add_patch(polygon1)

        # ax 2
        ax3.plot(W_box[:, 0], W_box[:, 1], 'r')
        ax3.plot(W.T[:, 0], W.T[:, 1], 'rx')

        polygon2 = Polygon(shape_wp_net[0:2, :].T, linewidth=2, edgecolor='b', facecolor='none')
        ax3.add_patch(polygon2)
